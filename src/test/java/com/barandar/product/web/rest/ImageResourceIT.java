...
class ImageResourceIT {
     ...
     *
     * @see com.barandar.product.repository.search.ImageSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    void searchImage() throws Exception {
        ...
        // Initialize the database
        imageRepository.saveAndFlush(image);
        when(mockImageSearchRepository.search(queryStringQuery("id:" + image.getId()))).thenReturn(Collections.singletonList(image));
