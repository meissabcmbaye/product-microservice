...
/**
 * Criteria class for the {@link com.barandar.product.domain.ProductCategory} entity. This class is used
 * in {@link com.barandar.product.web.rest.ProductCategoryResource} to receive all the possible filtering options from
...
public class ProductCategoryCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, description, productsId);
    }
