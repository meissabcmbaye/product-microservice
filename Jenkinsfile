pipeline {
        ...
        stages {
            ...
            stage('Image Vulnerability Scan') {
                steps {
                    // This fail the step if scan find high or critical vulnerabilities
            ...
            stage('Dynamic Application Analysis') {
                steps {
                    sh """ docker run --network="host" --rm -t owasp/zap2docker-stable zap-baseline.py -t ${microserviceURL} || true """
                }
            }
